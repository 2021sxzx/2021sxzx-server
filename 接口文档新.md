...
| --- | --- | --- |
| item_rule_id | string | 可选，事项规则id |
| create_time | string | 可选，创建时间 |
| rule_id | string | 可选，规则id |
| region_id | string | 可选，区划id |
| start_time | string | 可选，起始时间，有这个字段则create_time字段无用 |
| end_time | string | 可选，结束时间，有这个字段则create_time字段无用 |
