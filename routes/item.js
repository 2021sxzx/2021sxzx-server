...
router.post('/v1/getItemByUniId', async (req, res, next) => {
...
router.post('/v1/getItemsByRuleId', async (req, res, next) => {
    let data = await itemController.getItemsByRuleId(req.body)
    setStatusCode(res, data)
    res.json(data)
})

router.post('/v1/getItemsByRegionId', async (req, res, next) => {
...
router.post('/v1/getRulePath', async (req, res, next) => {
    let data = await itemController.getRulePath(req.body)
    setStatusCode(res, data)
    res.json(data)
})

router.post('/v1/getItemRulePath', async (req, res, next) => {
...
router.post('/v1/getAllItemsByRegionId', async (req, res, next) => {
...
router.post('/v1/getRegionPath', async (req, res, next) => {
